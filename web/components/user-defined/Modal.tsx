...
const Modal = ({ title, children, onClose, className = "" }: ModalProps) => {
    return (
      <div 
        ...
        <div 
          className={`bg-white p-6  rounded-lg border-2 shadow-[14px_14px_0px_0px_rgba(0,0,0,1)] border-black flex flex-col items-center max-h-[70vh] overflow-auto relative z-60 ${className}`}>
